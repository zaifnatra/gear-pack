                                    ...
                                    <div className="space-y-1 relative">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                className="block w-full rounded-xl border-neutral-200 bg-white/50 px-4 py-3 pr-10 text-neutral-900 placeholder:text-neutral-400 focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm shadow-sm transition-all"
                                                placeholder="••••••••"
                                            />
                                            <button
                                                type="button"
