...
export default function LoginPage() {
    ...
    return (
        <div className="w-full min-h-screen flex relative bg-neutral-900">
            ...
            <div className="flex-1 flex items-center justify-center p-4 sm:p-12 relative z-10 lg:bg-white bg-transparent">
                <div className="w-full max-w-md bg-white/95 backdrop-blur-sm lg:bg-transparent p-8 rounded-2xl shadow-2xl lg:shadow-none lg:p-0">
                    {/* Header */}
